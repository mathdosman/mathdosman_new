...
<form action="{{ route('adminupdate_post',['post_id'=>$post->id]) }}" method="POST" autocomplete="off" enctype="multipart/form-data" id="updatePostForm">
    @csrf
<div class="row">
    <div class="col-md-9">
        ...
        <div class="card card-box mb-2">
            ...
            <div class="card-body">
                <div class="from-group">
                    ...
                    <input type="text" class="form-control" name="meta_keywords" placeholder="Enter post meta keywords" value="{{ $post->meta_keyword}} ">
                </div>
                <div class="form-group">
        ...
        <div class="card card-box mb-2">
            <div class="card-body">
                ...
                <div class="d-block mb-3" style="max-width: 250px;">
                    <img src="/images/posts/resized/resized_{{ $post->featured_image }}" alt="" class="img-thumbnail" id="featured_image_preview">
                </div>
